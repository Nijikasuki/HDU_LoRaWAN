...
uint8_t Key_show_flag = 0;                //秘钥不可读标志，1密钥可读，0密钥不可读


//---------------------------------------------
//	@funtion:	initialization the lorawan module GPIOs
//	@paramters:	void
//	@return:	void
//----------------------------------------------
...
//---------------------------------------------
//	@funtion:	reset the lorawan module 
//	@paramters:	void
//	@return:	void
//----------------------------------------------
...
void Show_LoraNode_Key(Node_Info *lora_temp)
{
        uint8_t getpassword[100] ={0};	
        uint8_t i;
        uint8_t getPW_ZERO[] = ",0";	
	char GetAPPKEY[] = "AT+APPKEY?\r\n";	
	char *temp = "ERROR";
        char *temp1 = "+APPKEY:";
	char *ptr = NULL;	  
	...
	LoraNode_Read(AT_Data_buf);				/* receive the response of this command */
        ...
        if(StringStr((char *)AT_Data_buf, temp) != NULL)
        {
           // LoraNode_SetAppKey(appSKey_getpassword); 
           Key_show_flag = 0;
            
        }
        else if((ptr=StringStr((char *)AT_Data_buf, temp1)) != NULL)
        {
               Key_show_flag = 1;
//            for(uint8_t i=0;i<48;i++)
//            {
//                getpassword[i] = *(ptr + 8 + i);
//            }
//                StringCat(getpassword,getPW_ZERO);                
//                LoraNode_SetAppKey(getpassword); 
        }
}
//void Hide_LoraNode_Key()
...
void Printf_LoRaNode_Info(Node_Info LoRa_temp)
{
	...
	DEBUG_Printf("--> 模块网络模式 : ABP \r\n");
        ...
        {
            DEBUG_Printf("APPSKEY: 密钥不可读！ \r\n" );
            DEBUG_Printf("NWKSKEY: 密钥不可读！ \r\n" );            
        }
